...
namespace BAL.Repositories
{
    ...
    //		{
    //			string   plainText          = "4105240001994423";    // original plaintext
    //        
    ...
    //
    //			string  cipherText = EncrypDecrypt.Encrypt(plainText,
    //				passPhrase,
    //				saltValue,
    //				hashAlgorithm,
    //				passwordIterations,
    ...
    //           //passPhrase = "asif";
    //			plainText          = EncrypDecrypt.Decrypt(cipherText,
    //				passPhrase,
    //				saltValue,
    //				hashAlgorithm,
    //				passwordIterations,
